...
const TRIGGER_SOME_CHARACTERS_DIALOGUE_AT_LENGTH = 3;
...
const remarks: Record<RemarkType, Remark> = {
  ...
  success: {
    text: ["yeah! get ready for e-mail (jatt-mail)"],
    emote: "starstruck",
  },
  error: {
    text: [
      "computer says no",
      "that didn’t work",
      "it broke. idk, ill tell Harjot",
      "Harjot! everything fell apart",
      "try again?",
      "oh no. computers",
      "hm.. it broke. dang",
      "that didn’t work. hm",
...
export const SubscribeForm = () => {
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (e: FormEvent) => {
    ...
    const url = "https://buttondown.com/api/emails/embed-subscribe/harjot";
      ...
      <div className="subscribe-content">
        <div className="subscribe-header">
          <div>
            <h2>Subscribe</h2>
            <p>
              I send emails a few times a year about photography and web dev. Written
